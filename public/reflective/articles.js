...
(function () {
  ...
  var footballFitnessJunkContent =
    '<div class="reflective-article-modal football-fitness-junk-article">' +
      '<div class="football-fitness-junk-article__cover">' +
        '<img src="/reflective/covers/28-football-fitness-junk.png" alt="Football Promotes Both Fitness and Junk" class="football-fitness-junk-article__cover-img" loading="lazy" decoding="async">' +
      '</div>' +
      '<h1 id="reflective-modal-title">Football Promotes Both Fitness and Junk</h1>' +
      '<p>Elite football sells the dream of the perfect human body.</p>' +
      '<p>It celebrates cardiovascular supremacy, nutritional discipline, and athletic excellence at the absolute limit of what is possible.</p>' +
      '<p>Yet the multi-billion-dollar machine that funds this spectacle is built on gambling, alcohol, and junk food.</p>' +
      '<p>This is not a contradiction.</p>' +
      '<p>This is the system working exactly as designed.</p>' +
      '<p>This is Football Promotes Both Fitness and Junk.</p>' +
      '<p>The industry has perfected the psychological trick called the \u201cHealth Halo\u201d effect.</p>' +
      '<p>Take an ultra-fit athlete \u2014 the global symbol of discipline and peak performance \u2014 and place him next to a burger, a beer, or a betting advert. Suddenly the unhealthy product feels acceptable. Even aspirational.</p>' +
      '<p>The numbers are staggering.</p>' +
      '<p>The English Premier League alone generates \u00a37.3 billion in revenue every year. UEFA brings in more than \u20ac5 billion annually. FIFA\u2019s current World Cup cycle is budgeted at a massive $11 billion.</p>' +
      '<p>To keep this machine running, the image of the healthy athlete is deliberately weaponised. It bypasses consumer skepticism and tells millions of young fans that consuming ultra-processed food or alcohol is somehow compatible with a fit lifestyle.</p>' +
      '<p>This is modern capitalism in its purest form.</p>' +
      '<p>Football governing bodies maintain separate \u201csocial responsibility\u201d divisions that run health campaigns while their commercial arms sign huge deals with McDonald\u2019s, Coca-Cola, and betting companies. The health initiatives provide good PR. The commercial deals provide the real money.</p>' +
      '<p>The result is perfect cognitive dissonance on the pitch: players wear armbands promoting physical activity while giant sponsor boards behind them push junk food and alcohol for nearly a quarter of the match.</p>' +
      '<p>When public pressure grows, the industry simply swaps sponsors \u2014 moving from traditional junk food to delivery apps, only to go straight back to McDonald\u2019s the moment the money is bigger.</p>' +
      '<p>Football does not have a moral problem.</p>' +
      '<p>It has a business model.</p>' +
      '<p>And that business model perfectly reflects the morals of modern capitalism: profit always comes before public health.</p>' +
      '<p>The Reflective refuses to look away.</p>' +
      '<p>So be it.</p>' +
    '</div>';
  ...
  window.ARTICLES = [
    {
      id: 28,
      category: 'feature',
      slug: 'football-fitness-junk',
      title: 'Football Promotes Both Fitness and Junk',
      summary:
        'Elite football sells peak human fitness while being bankrolled by gambling, alcohol, and junk food giants. This is not a contradiction \u2014 it is the game working exactly as designed.',
      cover: '/reflective/covers/28-football-fitness-junk.png',
      readTime: '6 min read',
      topics: ['commercialism', 'public-health', 'sponsors', 'gambling'],
      relatedSlugs: ['gambling-fan-abuse', 'commodification', 'fifa-4-billion'],
      content: footballFitnessJunkContent
    },
    {
      id: 27,
      category: 'opinion',
